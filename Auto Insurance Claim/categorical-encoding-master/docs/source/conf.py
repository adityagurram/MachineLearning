...
# -*- coding: utf-8 -*-
#
# Category Encoders documentation build configuration file, created by
...
sys.path.insert(0, str(os.path.dirname(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))) + os.sep + 'category_encoders')
...
man_pages = [
    (master_doc, 'categoryencoders', 'Category Encoders Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'CategoryEncoders', 'Category Encoders Documentation',
   author, 'CategoryEncoders', 'One line description of project.',
   'Miscellaneous'),
]
